...
# - `data_getter` (`Callable`): function object to extract input data from 
# the sample prepared by dataloader.
# - `target_getter` (`Callable`): function object to extract target data from 
# the sample prepared by dataloader.
...
# - `loader` (`torch.utils.DataLoader`): dataset loader.
# - `device` (`str`): Specifies device at which samples will be uploaded.
# - `data_getter` (`Callable`): function object to extract input data from the sample 
# prepared by dataloader.
# - `target_getter` (`Callable`): function object to extract target data from the sample 
# prepared by dataloader.
# - `iterator_type` (`iterator`): type of the iterator. e.g. tqdm
# - `prefix` (`string`): prefix which will be add to the description string of progress bar.
# - `stage_progress` (`bool`): if True then progress bar will be show.
